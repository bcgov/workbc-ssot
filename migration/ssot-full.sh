...
ssconvert --export-type=Gnumeric_stf:stf_csv --export-file-per-sheet "data/FYP - Categories, Areas of interest, and NOCs 2025-04-22.xlsx" "data/FYP - Categories, Areas of interest, and NOCs 2025-04-22-%s.csv"
cat "data/FYP - Categories, Areas of interest, and NOCs 2025-04-22-CONSOLIDATED LIST.csv" | php csv_extract.php --range 2 | php csv_trimpad.php --column="3:L:5:0:#" > load/fyp_categories_interests.csv
