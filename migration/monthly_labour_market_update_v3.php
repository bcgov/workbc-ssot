 ...
 * This version is to be used for monthly updates that:
 * a) do not include city unemployment information at rows 50-55
 * b) include new industries at rows 73, 74
 *
...
$header_map = [
    ...
    'city_unemployment_pct_kelowna' => "NA",
    'city_unemployment_pct_abbotsford_mission' => "NA",
    'city_unemployment_pct_vancouver' => "NA",
    'city_unemployment_pct_victoria' => "NA",

    'industry_pct_accommodation_and_food_services' => [43,1],
    'industry_abs_accommodation_and_food_services' => [43,2],
    'industry_pct_agriculture' => [44,1],
    'industry_abs_agriculture' => [44,2],
    ...
    'industry_pct_finance_insurance_real_estate_rental' => [47,1],
    'industry_abs_finance_insurance_real_estate_rental' => [47,2],
    'industry_pct_health_care_and_social_assistance' => [48,1],
    'industry_abs_health_care_and_social_assistance' => [48,2],
    ...
    'industry_pct_other_services' => [51,1],
    'industry_abs_other_services' => [51,2],
    'industry_pct_professional_scientific_and_technical' => [52,1],
    'industry_abs_professional_scientific_and_technical' => [52,2],
    'industry_pct_public_administration' => [53,1],
    'industry_abs_public_administration' => [53,2],
    'industry_pct_transportation_and_warehousing' => [54,1],
    'industry_abs_transportation_and_warehousing' => [54,2],
    ...
    'industry_pct_business_building_other_support_services' => [57,1],
    'industry_abs_business_building_other_support_services' => [57,2],
    'industry_pct_information_culture_recreation' => [58,1],
    'industry_abs_information_culture_recreation' => [58,2],
];
