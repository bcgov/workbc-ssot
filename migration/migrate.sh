...
ssconvert --export-type=Gnumeric_stf:stf_csv --export-file-per-sheet "data/Occupational_Interests_2023_Feb13_24.xlsx" "data/Occupational_Interests_2023_Feb13_24-%s.csv"
cat "data/Occupational_Interests_2023_Feb13_24-Sheet 1.csv" | php csv_extract.php --range 2 > load/occupational_interests.csv
