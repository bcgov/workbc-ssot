...
# Wage Data
ssconvert --export-type=Gnumeric_stf:stf_csv --export-file-per-sheet "data/WorkBC_2022_Wage_Data.xlsx" "data/WorkBC_2022_Wage_Data-%s.csv"
cat "data/WorkBC_2022_Wage_Data-Sheet1.csv" | php csv_extract.php --range 2 > load/wages.csv
