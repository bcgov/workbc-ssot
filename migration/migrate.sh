...
# Career Trek
ssconvert --export-type=Gnumeric_stf:stf_csv --export-file-per-sheet "data/WorkBC_Career_Trek_2023__Apr11_24.xlsx" "data/WorkBC_Career_Trek_2023__Apr11_24-%s.csv"
cat "data/WorkBC_Career_Trek_2023__Apr11_24-LMO.csv" | php csv_extract.php --range 2 > load/career_trek.csv
