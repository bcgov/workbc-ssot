...
$header_map = [
    ...
    'industry_abs_agriculture_fishing' => [49,2],
    ...
    'industry_pct_finance_insurance_real_estate' => [52,1],
    'industry_abs_finance_insurance_real_estate' => [52,2],
    'industry_pct_health_care_social_assistance' => [53,1],
    'industry_abs_health_care_social_assistance' => [53,2],
    ...
    'industry_pct_other_private_services' => [56,1],
    'industry_abs_other_private_services' => [56,2],
    'industry_pct_professional_scientific_technical_services' => [57,1],
    'industry_abs_professional_scientific_technical_services' => [57,2],
    'industry_pct_public_administration' => [58,1],
    'industry_abs_public_administration' => [58,2],
    'industry_pct_transportation_warehousing' => [59,1],
    'industry_abs_transportation_warehousing' => [59,2],
    'industry_pct_utilities' => [60,1],
    'industry_abs_utilities' => [60,2],
    'industry_pct_wholesale_retail_trade' => [61,1],
    'industry_abs_wholesale_retail_trade' => [61,2],
];
