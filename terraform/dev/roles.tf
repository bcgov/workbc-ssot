...
resource "aws_iam_role" "workbc_ssot_container_role" {
...
#resource "aws_iam_role_policy" "workbc_ssot_container_efs" {
#  name   = "workbc_cc_container_efs"
#  role   = aws_iam_role.workbc_ssot_container_role.id
#  policy = <<-EOF
#  {
#      "Version": "2012-10-17",
...
#resource "aws_iam_role_policy" "workbc_ssot_container_ses" {
